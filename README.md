This project was created with [Create React App](https://github.com/facebookincubator/create-react-app) with tachyons for frontend side -- node and postgres sql for backend side.
